...
const validateProfileInput = require("../../validators/profiles");
...
// @access Public
router.get("/test", (req, res) => console.log("profile"));

// @route GET api/profile/all
// @desc Get all user's public profile
// @access Public
			...
			.then(profile => {
				if (profile) {
					...
					Profile.findOne({ handle: profileFields.handle }).then(profile => {
						if (profile) {
							errors.handle = "That profile name already exists";
